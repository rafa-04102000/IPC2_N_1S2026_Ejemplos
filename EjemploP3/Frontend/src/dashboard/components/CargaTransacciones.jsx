...
const CargaTransacciones = () => {
    ...
    const handleUpload = async (e) => {
        ...
        try {
            // Cambiamos el endpoint a Transaccion/Cargar según tu Postman
            ...
            // Guardamos la respuesta XML
            setResponseXml(response.data);

            // Notificación de éxito
            sileo.success({
                title: "Transacciones Cargadas",
                description: "El archivo de transacciones se ha procesado exitosamente.",
                fill: "black",
                styles: {
            ...
            console.error(err);
            setError('Hubo un error al procesar las transacciones. Verifica la conexión con la API.');
            
            // Notificación de error
            sileo.error({
                title: "Error",
                description: "Hubo un error al cargar el archivo de transacciones.",
                fill: "black",
                styles: {
                    title: "text-red-400",
    ...
    const handleDownload = () => {
        ...
        link.setAttribute('download', 'respuestaTransacciones.xml'); // Nombre de descarga actualizado
    ...
    return (
        <>
            ...
            <div className="p-8 max-w-4xl mx-auto">
                <h2 className="text-3xl font-bold mb-6 text-black">Carga de Transacciones</h2>

                <div className="bg-white p-6 rounded-lg shadow-md border border-[#525252]">
                    <p className="text-gray-600 mb-6">Selecciona tu archivo de transacciones (.xml) para procesar los pagos y facturas.</p>
