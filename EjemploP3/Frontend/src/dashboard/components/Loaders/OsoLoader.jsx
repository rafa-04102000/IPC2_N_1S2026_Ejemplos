...
const OsoLoader = () => {
  return (
    <>
      {/* Estilos para pseudo-elementos y animaciones complejas */}
      <style>{`
        /* Dibujo y animación de la cara (ojos, nariz, etc.) */
        .loader-face::after {
          content: "";
          position: absolute;
          width: 100px;
        ...
        /* Dibujo y animación de las orejas */
        .loader-face::before {
          content: "";
          position: absolute;
          width: 140%;
      ...
      <div className="relative w-[160px] h-[185px] bg-white rounded-t-[100px] loader-face" />
    </>
  );
}

export default OsoLoader;