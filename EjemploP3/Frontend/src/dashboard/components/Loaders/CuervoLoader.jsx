...
const CuervoLoader = () => {
  return (
    <>
      ...
      <style>{`
        .animate-bob { animation: bob 1s infinite ease-in; }
        .animate-bob-alt { animation: bob 1s infinite ease-in-out; }
        .animate-lstep { animation: lstep 1s infinite ease-in; }
        .animate-rstep { animation: rstep 1s infinite ease-in; animation-delay: 0.45s; }
        .animate-scroll { animation: scroll 5s infinite linear; }
        ...
        @keyframes scroll {
          ...
          33%, 66% { opacity: 0.25; }
          100% { transform: translateY(-50px) translate(-100px); opacity: 0; }
        }
      `}</style>

      {/* Contenedor principal usando Tailwind (reemplaza a StyledWrapper y .loader) */}
      <div className="relative w-[200px] h-[200px] scale-75 translate-x-[10px] -translate-y-[20px] [&_svg]:absolute [&_svg]:top-0 [&_svg]:left-0">
        
        {/* Pierna Izquierda */}
        <svg className="animate-lstep z-[3] translate-x-[30px] translate-y-[155px]" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20.69332" height="68.19944" viewBox="0,0,20.69332,68.19944">
        ...
        {/* Pierna Derecha */}
        <svg className="animate-rstep z-0 translate-x-[75px] translate-y-[135px]" version="1.1" xmlns="http://www.w3.org/2000/svg" width="41.02537" height="64.85502" viewBox="0,0,41.02537,64.85502">
        ...
        {/* Cuerpo (agrupa torso y cabeza) */}
        <div className="animate-bob-alt z-[3] translate-x-[0px] translate-y-[30px]">
          {/* Torso */}
          ...
          {/* Cabeza */}
          <svg className="animate-bob z-[3] translate-x-[27px] -translate-y-[30px]" version="1.1" xmlns="http://www.w3.org/2000/svg" width="115.68559" height="88.29441" viewBox="0,0,115.68559,88.29441">
        ...
        {/* Sombra / Suelo */}
        <svg className="animate-scroll z-[-1] -translate-x-[140px] translate-y-0 rotate-[10deg] opacity-25 blur-[0.5px] drop-shadow-[1px_3px_5px_#000000]" version="1.1" xmlns="http://www.w3.org/2000/svg" width={475} height={530} viewBox="0,0,163.40011,85.20095">
